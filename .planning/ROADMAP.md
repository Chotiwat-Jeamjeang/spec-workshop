...
- [x] 01-01-PLAN.md — Walking Skeleton tracer: signed QR URL renders the locked report form end-to-end

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 01-02-PLAN.md — Dropdown location picker, empty-registry state, and invalid-QR rejection
- [x] 01-03-PLAN.md — Responsive stylesheet per the UI contract, zero external requests
- [x] 01-04-PLAN.md — QR generation ops CLI with a mint-then-verify round-trip test

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 01-05-PLAN.md — "ไม่ใช่จุดนี้" mis-scan recovery and the optional note field with a Thai-correct counter

**Wave 4** *(blocked on Wave 3 completion)*

- [x] 01-06-PLAN.md — Server-side validate endpoint and CTA wiring with loading/error states

**Wave 5** *(blocked on Wave 4 completion)*

- [x] 01-07-PLAN.md — FCP measurement under simulated 4G and responsive verification at 375/768/1024px
